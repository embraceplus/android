...
public class TimeSwitch extends LinearLayout implements OnClickListener {

	protected boolean isCheck = false;
	// private String checkedText = "";
	// private String uncheckedText = "";
	// private TextView checkedTextView, uncheckedTextView;
	TimeSwitchOnCheckedChangeListener onCheckedChangeListener;
	...
	public TimeSwitch(Context context, AttributeSet attrs) {
		super(context, attrs);
		...
		// uncheckedTextView = (TextView)
		// view.findViewById(R.id.uncheckedTextView);
		// if (checkedText != null) {
	...
	public void setOnCheckedChangeListener(TimeSwitchOnCheckedChangeListener onCheckedChangeListener) {
	...
	private void setCheckButton() {
		if (isCheck) {
			this.setBackgroundResource(R.drawable.once);
			// checkedTextView.setTextColor(swithOnColor);
			// uncheckedTextView.setTextColor(swithOffColor);
		} else {
			this.setBackgroundResource(R.drawable.hour1);
